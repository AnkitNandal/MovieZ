...
class kNetworkAdapter: NSObject,KOperationDelegate {
    ...
    /// Shared instance to bes used for specific purposed only.
    ...
    func getMoviesSearchResult(searchTerm:String,pageNo:Int, completionBlock:@escaping NACompletionBlock) {
